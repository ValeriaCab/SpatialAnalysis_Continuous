# **Análisis de adaptación local en paisajes heterogéneos mediante simulaciones SLiM**

## Abstract 
La relación entre la intensidad de la selección direccional y el fenotipo de los individuos en un entorno es un tema ampliamente estudiado en biología evolutiva. Su estudio nos permite anticipar cómo responden las poblaciones a presiones selectivas como los cambios climáticos, la disponibilidad de diferentes recursos y la competencia con otras especies.
