...
if (length(args) > 0) {
  ...
  base_path <- "/mnt/data/dortega/vcabrera/output/1_Homogeneo_output/h2_05/"
}
...
for (dir in carpetas_numericas) {
  ...
  plot(
    ...
    ylab = "Phenotype (Phen)",
    main = paste0("Relationship Between Phenotype and Its Optimum (h2 = 0.5)\nReplica ", num),
    pch = 19,
    col = "lightgray",
...
##############################
  ...
  points(
    datos_plot5$Opt[datos_plot5$Region == 1],
    datos_plot5$Phen[datos_plot5$Region == 1],
    col = "yellow", pch = 19
  )
  points(
    datos_plot5$Opt[datos_plot5$Region == 2],
    datos_plot5$Phen[datos_plot5$Region == 2],
    col = "yellow", pch = 19
  )
  points(
    datos_plot5$Opt[datos_plot5$Region == 3],
    datos_plot5$Phen[datos_plot5$Region == 3],
    col = "yellow", pch = 19
  )

  points(
    datos_plot5$Opt[datos_plot5$Region == 4],
    datos_plot5$Phen[datos_plot5$Region == 4],
    col = "yellow", pch = 19
  )

  points(
    datos_plot5$Opt[datos_plot5$Region == 5],
    datos_plot5$Phen[datos_plot5$Region == 5],
    col = "yellow", pch = 19
  )
...
##############################
  ...
  points(
    datos_plot10$Opt[datos_plot10$Region == 1],
    datos_plot10$Phen[datos_plot10$Region == 1],
    col = "yellow", pch = 19
  )
  points(
    datos_plot10$Opt[datos_plot10$Region == 2],
    datos_plot10$Phen[datos_plot10$Region == 2],
    col = "yellow", pch = 19
  )
  points(
    datos_plot10$Opt[datos_plot10$Region == 3],
    datos_plot10$Phen[datos_plot10$Region == 3],
    col = "yellow", pch = 19
  )

  points(
    datos_plot10$Opt[datos_plot10$Region == 4],
    datos_plot10$Phen[datos_plot10$Region == 4],
    col = "yellow", pch = 19
  )

  points(
    datos_plot10$Opt[datos_plot10$Region == 5],
    datos_plot10$Phen[datos_plot10$Region == 5],
    col = "yellow", pch = 19
  )

  points(
    datos_plot10$Opt[datos_plot10$Region == 6],
    datos_plot10$Phen[datos_plot10$Region == 6],
    col = "yellow", pch = 19
  )

  points(
    datos_plot10$Opt[datos_plot10$Region == 7],
    datos_plot10$Phen[datos_plot10$Region == 7],
    col = "yellow", pch = 19
  )

  points(
    datos_plot10$Opt[datos_plot10$Region == 8],
    datos_plot10$Phen[datos_plot10$Region == 8],
    col = "yellow", pch = 19
  )

  points(
    datos_plot10$Opt[datos_plot10$Region == 9],
    datos_plot10$Phen[datos_plot10$Region == 9],
    col = "yellow", pch = 19
  )

  points(
    datos_plot10$Opt[datos_plot10$Region == 10],
    datos_plot10$Phen[datos_plot10$Region == 10],
    col = "yellow", pch = 19
  )
  ...
  legend(
    ...
    col = c("yellow", "yellow", "yellow", "yellow", "yellow", "yellow", "yellow", "yellow", "yellow", "yellow"),
    pch = 19
  )
  ...
  p_box <- ggplot(datos_plot3, aes(x = factor(Region), y = Phen, fill = factor(Region))) +
    ...
    scale_fill_manual(
      values = c("1" = "yellow", "2" = "yellow", "3" = "yellow")
    ) +
    labs(
  ...
  p_box <- ggplot(datos_plot5, aes(x = factor(Region), y = Phen, fill = factor(Region))) +
    geom_boxplot(color = "black") +
    scale_fill_manual(
      values = c("1" = "yellow", "2" = "yellow", "3" = "yellow", "4" = "yellow", "5" = "yellow")
    ) +
    labs(
      title = paste0("Average phenotypic value by region (Replica ", num, ")"),
      x = "Region",
  ...
  p_box <- ggplot(datos_plot10, aes(x = factor(Region), y = Phen, fill = factor(Region))) +
    ...
    scale_fill_manual(
      values = c("1" = "yellow", "2" = "yellow", "3" = "yellow", "4" = "yellow", "5" = "yellow"
                  , "6" = "yellow", "7" = "yellow", "8" = "yellow", "9" = "yellow", "10" = "yellow")
    ) +
    labs(
      title = paste0("Average phenotypic value by region (Replica ", num, ")"),
      x = "Region",
  ...
  plot(
    ...
    xlab = "Phenotype",
    ylab = "Z individual",
    main = paste0("Phenotype-genotype relationship (h2 = 0.5)\nReplica ", num),
    pch = 19,
    col = "black",
